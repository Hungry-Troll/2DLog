...
public class CreatureController2 : MonoBehaviour
{
    ...
    public Vector3Int CellPos { get; set; } = new Vector3Int(0, -1, 0); //내가 이동하고자 하는 위치
    ...
    {   //계산
        ...
        transform.DOMove(destPos, 1.0f).SetEase(Ease.Linear).OnComplete(() => { Dir = MoveDir.None; });
